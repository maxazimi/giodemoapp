...
var ImageViewIcon *widget.Icon = func() *widget.Icon {
	icon, _ := widget.NewIcon(icons.ImageViewComfy)
	return icon
}()

var ChartViewIcon *widget.Icon = func() *widget.Icon {
	icon, _ := widget.NewIcon(icons.EditorShowChart)
	return icon
}()

var DialIcon *widget.Icon = func() *widget.Icon {
	icon, _ := widget.NewIcon(icons.CommunicationDialpad)
	return icon
}()

var ClockIcon *widget.Icon = func() *widget.Icon {
	icon, _ := widget.NewIcon(icons.HardwareWatch)
	return icon
}()
